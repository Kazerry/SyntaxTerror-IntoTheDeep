...
@Autonomous(name = "1 + Park Auto Blue", group = "!Auto")
public class OneParkAutoBlue extends OpMode {

    private Follower follower;
    private Timer pathTimer, opmodeTimer, initTimer;
    public static Timer parkTimer;
    private int pathState, caseState;
    ...
    public void loop(){
        ...
        if (opmodeTimer.getElapsedTimeSeconds() > 29.75) {
            stop();
        }
    }
