...
public class Limelight {
    ...
    public void LimelightInit(Limelight3A limelight, Follower follower, Pose startPose) {
        ...
        MT2Heading = startPose.getHeading();
        limelight.start();
    ...
    public void getPose() {
        ...
        //limelight.updateRobotOrientation(Math.toDegrees(MT2Heading) + 270);
        Pose3D botpose = limelight.getLatestResult().getBotpose(); // you can do getBotpose_MT2();
